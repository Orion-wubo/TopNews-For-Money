package com.fengmap.kotlindemo.view;
...
public class CustomePopwindow implements PopupWindow.OnDismissListener{
    ...
    private CustomePopwindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public CustomePopwindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public CustomePopwindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public CustomePopwindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public CustomePopwindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        ...
        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new CustomePopwindow(context);
        }
        ...
        public CustomePopwindow create(){
            //构建PopWindow
