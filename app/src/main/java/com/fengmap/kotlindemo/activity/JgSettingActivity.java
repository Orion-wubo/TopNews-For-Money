...
public class JgSettingActivity extends InstrumentedActivity implements OnClickListener {
   ...
   @Override
	...
	private void setPushTime(){
		...
		if (startime > endtime) {
			Toast.makeText(JgSettingActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
			return;
		}
		...
		mEditor.commit();
		Toast.makeText(JgSettingActivity.this, R.string.setting_su, Toast.LENGTH_SHORT).show();
	}
